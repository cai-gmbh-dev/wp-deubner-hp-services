...
class DHPS_Steuertermine {
    ...
    private function render_template( array $tax_dates, string $layout, string $css_class, ?DHPS_Content_Collection $collection = null ): string {
        ...
        // v0.19.1: $service_tag direkt im Template-Scope, $data komplett raus.
        // Templates erhalten Tax-Dates-Array als $months (Rename aus
        // semantischen Gruenden - $data war irrefuehrend, ist Iteration
        // ueber Monatsspalten).
        $service_tag = 'mio';
