...
define( 'DEUBNER_HP_SERVICES_VERSION', '0.14.4' );
...
/** @var string Alpine.js-Vendor-Version (lokal gebundled, seit 0.14.4). */
...
/*
|--------------------------------------------------------------------------
| Component-System-Helpers (v0.14.4)
|--------------------------------------------------------------------------
|
...
function dhps_init() {
    ...
    // 3b. Component-Registry: UI-Bausteine registrieren (v0.14.4).
    ...
    // 4b. MMB-Lazy-Akkordeon AJAX-Endpoint (v0.14.4).
...
function dhps_enqueue_frontend_styles() {
    ...
    // Seit 0.14.4. Wird sofort geladen, weil die Components ueberall potentiell verwendet werden.
    wp_register_style(
        'dhps-components-css',
    ...
    // Elementor-Atomic-Token-Bridge (seit 0.14.4, optional, Default aus).
    ...
    // MAES-Aktuelles JS-Block in v0.13.1 -> v0.14.4 ausgelagert,
    // in v0.14.4 obsolet: ContentCard's Alpine-Toggle uebernimmt die
    // Akkordeon-Funktion. File geloescht, Enqueue entfernt.

    // Alpine.js v3.x Vendor (lokal gebundled, defer, conditional enqueue, seit 0.14.4).
    wp_register_script(
...
/*
|--------------------------------------------------------------------------
| Component-Registry-Bootstrap (v0.14.4)
|--------------------------------------------------------------------------
|
...
function dhps_register_components() {
    ...
    DHPS_Component_Registry::register( 'content-card', array(
        'default_props'   => array(
            ...
            'class'       => '',
            'service'     => '',
            'data_attrs'  => array(),  // seit 0.14.4 - data-* fuer Player-Selectoren etc.
        ),
        'stateful'        => true,
...
/*
|--------------------------------------------------------------------------
| Alpine.js Conditional Loading (v0.14.4)
|--------------------------------------------------------------------------
|
 ...
 *
 * Seit 0.14.4. Aktuell nur Bridge-Toggle, weitere Optionen wandern bei
