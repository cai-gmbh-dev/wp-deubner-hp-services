<?php
/**
 * Layout-Template: Standard (default).
 *
 * Einfacher Wrapper-Container ohne zusaetzliche visuelle Dekorationen.
 * Kann vom Theme ueberschrieben werden unter: {theme}/dhps/layout-default.php
 *
 ...
 * - $layout_class  (string) CSS-Klasse fuer das Layout (z.B. 'dhps-layout--default').
